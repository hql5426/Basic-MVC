...
public class FXMLDocumentController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TableColumn<Voter, String> fNameColumn;

    @FXML
    private TableColumn<Voter, String> lNameColumn;

    @FXML
    private TableColumn<Voter, String> partyColumn;

    @FXML
    private TableColumn<Voter, Boolean> hasVotedColumn;
    ...
    private ObservableList<Voter> voterData;
   ...
   public void setTableData(List<Voter> voterList) {
    ...
    void searchfName(ActionEvent event) {
        ...
        List<Voter> voters = readByfirstName(name);
    ...
    void actionShowDetails(ActionEvent event) throws IOException {
        ...
        detailedControlled.initData(selectedVoter);
